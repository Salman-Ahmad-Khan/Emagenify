            ...
            <div className="flex justify-between space-x-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-base text-dark-500">
                  Creatively transform your images, using AI to automatically
                  generate pixels that integrate seamlessly into the picture.
                  Use these transformations to extend your images to new
                  dimensions, remove, replace or recolor items, or restore
                  degraded images.
                </p>
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="item-1">
                    ...
                    <AccordionContent className="text-dark-500">
                      Generative fill, utilized with various cropping methods,
                      uses AI to expand original images, aiding in orientation
                      changes. It seamlessly integrates AI-generated backgrounds
                      with existing content, facilitating creative solutions and
                  ...
                  <AccordionItem value="item-2">
                    ...
                    <AccordionContent className="text-dark-500">
                      Generative recolor enables color alterations in images
                      using natural language, through AI and NLP. This feature
                      simplifies creating color variants, especially beneficial
                  ...
                  <AccordionItem value="item-3">
                    ...
                    <AccordionContent className="text-dark-500">
                      Generative remove effortlessly eliminates unwanted
                      objects, text, or user-defined regions from
                      images,enabling scalable object removal tasks which
                      traditionally would require significant time and effort.
                    </AccordionContent>
                  </AccordionItem>
        ...
        <nav className="sidebar-nav">
          ...
          <SignedOut>
            ...
            <div className="relative grid w-full max-w-[28rem] flex-col items-end justify-center overflow-hidden rounded-xl bg-white bg-clip-border text-center text-gray-700">
              <div className="absolute inset-0 m-0 h-full w-full overflow-hidden rounded-none bg-transparent bg-[url('/assets/images/side-img.avif')] bg-cover bg-clip-border bg-center text-gray-700 shadow-none">
